...
public class GameController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        var pos2 = pos1 + (Vector3.left + Vector3.forward) * 120;
        //if the level is by the number of two
        //    var pos3 = pos1 - ((Level % 2 == 0) ? Vector3.left : Vector3.forward) * 120;
        var pos3 = pos1 - (Vector3.left + Vector3.forward) * 120;
        if (Level % 2 == 0)
        {
    ...
    //New Block function to create new blockis
    //for the game
    void Newblock()
    {
        ...
        if(lastCube != null)
        {
            ...
            //current cube size on the  axis is less
            //than or equal to 0
